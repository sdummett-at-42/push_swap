...
/*   Updated: 2021/09/08 15:50:23 by sdummett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** It returns the index of the number in stack A that comes after the number
** given as parameter
*/
...
unsigned int	get_next_value_index(t_stacks *stacks, int elem_to_sort)
{
	...
	if (elem_to_sort > get_max_number(stacks) || \
	elem_to_sort < get_min_number(stacks))
